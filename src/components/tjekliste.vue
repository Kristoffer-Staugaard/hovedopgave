...
<template>
    ...
    <div class="checkbox-class"><div class="unchecked-box"></div>div<p>Praktiksøgning</p></div>
    ...
    <div class="checkbox-class"><div class="checked_box"></div><p>LinkedIn profil</p></div>
    <div class="checkbox-class"><div class="checked-box"></div>div<p>Praktiksøgning</p></div>
